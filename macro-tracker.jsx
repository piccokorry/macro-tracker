...
const SAVED_MEALS = [
  {
    ...
    items: [
      { name: "Water + Sea Salt + Creatine", calories: 20, protein: 5, carbs: 0, fat: 0, qty: 1, per: 1, unit: "serving" },
    ]
  },
  {
...
function SavedMealModal({ meal, onConfirm, onClose }) {
  const [items, setItems] = useState(meal.items.map(item => ({ ...item, included: true })));
